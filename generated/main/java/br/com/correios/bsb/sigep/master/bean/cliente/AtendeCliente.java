...
public interface AtendeCliente {
    ...
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "consultaSRO_NEW", targetNamespace = "http://cliente.bean.master.sigep.bsb.correios.com.br/", className = "br.com.correios.bsb.sigep.master.bean.cliente.ConsultaSRONEW")
    @ResponseWrapper(localName = "consultaSRO_NEWResponse", targetNamespace = "http://cliente.bean.master.sigep.bsb.correios.com.br/", className = "br.com.correios.bsb.sigep.master.bean.cliente.ConsultaSRONEWResponse")
